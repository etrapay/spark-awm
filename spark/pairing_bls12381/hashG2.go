/*
This code is taken from Celer Network's Brevis project
...
func GetRawLimbsBy8Uint64(api frontend.API, v [8]frontend.Variable) *emulated.Element[emulated.BLS12381Fp] {
	f, err := emulated.NewField[emulated.BLS12381Fp](api)
	if err != nil {
		log.Fatal(err)
	}
...
func g2SqrtRatio(api frontend.API, u *E2, v *E2) (z *E2, isQNr frontend.Variable) {
	...
	tv1 := E2{
		A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{8921533702591418330, 15859389534032789116, 3389114680249073393, 15116930867080254631, 3288288975085550621, 1021049300055853010}),
		A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{8921533702591418330, 15859389534032789116, 3389114680249073393, 15116930867080254631, 3288288975085550621, 1021049300055853010}),
	}
	...
	c7 := E2{
		A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{1921729236329761493, 9193968980645934504, 9862280504246317678, 6861748847800817560, 10375788487011937166, 4460107375738415}),
		A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{16821121318233475459, 10183025025229892778, 1779012082459463630, 3442292649700377418, 1061500799026501234, 1352426537312017168}),
	}
...
func g2IsogenyXDenominator(api frontend.API, x *E2) *E2 {
	...
	coefficients := [2]*E2{
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{2250392438786206615, 17463829474098544446, 14571211649711714824, 4495761442775821336, 258811604141191305, 357646605018048850}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{4933130441833534766, 15904462746612662304, 8034115857496836953, 12755092135412849606, 7007796720291435703, 252692002104915169}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{8469300574244328829, 4752422838614097887, 17848302789776796362, 12930989898711414520, 16851051131888818207, 1621106615542624696}),
		},
	}
...
func g2IsogenyXNumerator(api frontend.API, x *E2) *E2 {
	...
	coefficients := [4]*E2{
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{5185457120960601698, 494647221959407934, 8971396042087821730, 324544954362548322, 14214792730224113654, 1405280679127738945}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{5185457120960601698, 494647221959407934, 8971396042087821730, 324544954362548322, 14214792730224113654, 1405280679127738945}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{6910023028261548496, 9745789443900091043, 7668299866710145304, 2432656849393633605, 2897729527445498821, 776645607375592125}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{724047465092313539, 15783990863276714670, 12824896677063784855, 15246381572572671516, 13186611051602728692, 1485475813959743803}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{12678383550985550056, 4872894721950045521, 13057521970209848460, 10439700461551592610, 10672236800577525218, 388322803687796062}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{4659755689450087917, 1804066951354704782, 15570919779568036803, 15592734958806855601, 7597208057374167129, 1841438384006890194}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
		},
	}
...
func g2IsogenyYDenominator(api frontend.API, x *E2) *E2 {
	...
	coefficients := [3]*E2{
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{99923616639376095, 10339114964526300021, 6204619029868000785, 1288486622530663893, 14587509920085997152, 272081012460753233}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{99923616639376095, 10339114964526300021, 6204619029868000785, 1288486622530663893, 14587509920085997152, 272081012460753233}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{6751177316358619845, 15498000274876530106, 6820146801716041242, 13487284328327464010, 776434812423573915, 1072939815054146550}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{7399695662750302149, 14633322083064217648, 12051173786245255430, 9909266166264498601, 1288323043582377747, 379038003157372754}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{6002735353327561446, 6023563502162542543, 13831244861028377885, 15776815867859765525, 4123780734888324547, 1494760614490167112}),
		},
	}
...
func g2IsogenyYNumerator(api frontend.API, x, y *E2) *E2 {
	...
	coefficients := [4]*E2{
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{10869708750642247614, 13056187057366814946, 1750362034917495549, 6326189602300757217, 1140223926335695785, 632761649765668291}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{10869708750642247614, 13056187057366814946, 1750362034917495549, 6326189602300757217, 1140223926335695785, 632761649765668291}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{13765940311003083782, 5579209876153186557, 11349908400803699438, 11707848830955952341, 199199289641242246, 899896674917908607}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{15562563812347550836, 2436447360975022760, 6528760985104924230, 5219850230775796305, 5336118400288762609, 194161401843898031}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{16286611277439864375, 18220438224251737430, 906913588459157469, 2019487729638916206, 75985378181939686, 1679637215803641835}),
		},
		{
			A0: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{11849179119594500956, 13906615243538674725, 14543197362847770509, 2041759640812427310, 2879701092679313252, 1259985822978576468}),
			A1: emulated.ValueOf[emulated.BLS12381Fp](fp.Element{0}),
		},
	}
...
func (m *Pairing) E2NotZero(x E2) frontend.Variable {
	a0NotZero := G1NotZero(m.api, x.A0)
	a1NotZero := G1NotZero(m.api, x.A1)
	return m.api.Or(a0NotZero, a1NotZero)
}

func (m *Pairing) G1NotZero(x BaseEl) frontend.Variable {
	ba, err := emulated.NewField[emulated.BLS12381Fp](m.api)
	if err != nil {
		log.Fatal(err)
	}
	x = *ba.Reduce(&x)
	...
	isNotZero = 0
	for _, b := range bs {
		isNotZero = m.api.Or(isNotZero, b)
	}
	return isNotZero
}
...
func (m *Pairing) G1NotEqual(x, y BaseEl) frontend.Variable {
	...
	notEqual = 0
	for i, b := range xBits {
		notEqual = m.api.Or(notEqual, m.api.Xor(b, yBits[i]))
	}
...
func (m *Pairing) E2NotEqual(x, y E2) frontend.Variable {
	...
	a0NotEqual = G1NotEqual(m.api, x.A0, y.A0)
	a1NotEqual = G1NotEqual(m.api, x.A1, y.A1)
	return m.api.Or(a0NotEqual, a1NotEqual)
}
...
func (m *Pairing) GetG2JacFromG2Affine(Q *G2Affine) *G2Jacobian {
	...
	// }
	et2 := NewExt2(m.api)
	g2NotInfinity := G2AffineNotInfinity(m.api, Q)
...
func (m *Pairing) G2AffineNotInfinity(a *G2Affine) frontend.Variable {
	xNotZero := E2NotZero(m.api, a.X)
	yNotZero := E2NotZero(m.api, a.Y)
	return m.api.Or(xNotZero, yNotZero)
}

func HashToField(api frontend.API, msg [32]frontend.Variable, count int) []E2 {
	emx := ExpandMsgXmd(api, msg, count)
	u := make([]*emulated.Element[emulated.BLS12381Fp], count)
	for i := 0; i < count; i++ {
...
func (m *Pairing) HashToG2(msg [32]frontend.Variable) *G2Affine {
	e2 := HashToField(m.api, msg, 4)

	Q0X, Q0Y := MapElementToCurve2(m.api, e2[0])
	Q1X, Q1Y := MapElementToCurve2(m.api, e2[1])

	Q0 := G2Isogeny(m.api, &G2Affine{
		X: *Q0X,
		Y: *Q0Y,
	})
	Q1 := G2Isogeny(m.api, &G2Affine{
		X: *Q1X,
		Y: *Q1Y,
	})

	sum := G2AddAssign(m.api, *Q0, *Q1)
	sum = G2ClearCofactor(m.api, *sum)
	XA0 := m.Ext2.fp.Reduce(&sum.X.A0)
	XA1 := m.Ext2.fp.Reduce(&sum.X.A1)
	YA0 := m.Ext2.fp.Reduce(&sum.Y.A0)
	YA1 := m.Ext2.fp.Reduce(&sum.Y.A1)
